...
namespace FeedingTube
{
    internal class Job_FillTube : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            job.count = job.GetTarget(FoodToLoad).Thing.stackCount > foodNeeded ? foodNeeded : job.GetTarget(FoodToLoad).Thing.stackCount;
            ...
            yield return waitingToil.FailOnSomeonePhysicallyInteracting(TubeToFill).FailOnDespawnedNullOrForbidden(TubeToFill);
            ...
            yield return fillTubeToil.FailOnSomeonePhysicallyInteracting(TubeToFill).FailOnDespawnedNullOrForbidden(TubeToFill);
        }
    }
}